...
```{r}
# 5. Reemplazar todos los 0m^2 por NA (ahora los NA son 128+5254)
...
```{r}
# 6.Pinta el histograma (ponemos break para mostrar más detalle)
...
df_sq_Neigh$Neighbourhood
df_madrid <- df_madrid[df_madrid$Neighbourhood != df_sq_Neigh$Neighbourhood,]
head(df_madrid)
```
