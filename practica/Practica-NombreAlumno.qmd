...
hist(x = df_madrid$Square.Meters, ylim = c(0, 120), main = 'Histogram of Sqm Madrid rooms', xlab = "Square meters", ylab = 'Frecuency', col = 'lightblue', cex.axis = 1.5, cex.lab = 1.8, cex.main = 2.0) 
```
