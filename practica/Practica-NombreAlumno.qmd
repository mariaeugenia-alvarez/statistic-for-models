...
#nos da un valor de R2 menor que con training y además el RMSE es mayor, lo que puede indicar overfitting. Vamos a probar con un modelo más simple según los p-valores de arriba.
