...
```{r}
# 4. % apartamentos distintos de NA con valor 0 en Square.Meters (128 '0' en Sqm, 36.98%)
...
#Usamos el test kruskal. La hipotesis nula es que las medias fueran iguales en todos los barrios. El p-valor 0.01074 nos indica que existen diferencias significativas y que no podemos asegurar que todos los barrios tienen los mismos metros cuadrados de media. 
kruskal.test(Square.Meters ~ Neighbourhood , data=df_madrid)
```

```{r}
# 10. Matriz de similaridad de Tukey.
