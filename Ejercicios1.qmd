...
```{r}
fumadoras <- bwt$Birthweight[bwt$Smoke == "YES"]
no_fumadoras <- bwt$Birthweight[bwt$Smoke == "NO"] 
...
crear_boxplot(fumadoras, "Boxplot peso - Mujeres Fumadoras")
crear_boxplot(no_fumadoras, "Boxplot peso - Mujeres NO Fumadoras")
```
